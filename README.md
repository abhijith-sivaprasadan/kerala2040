...
Nine gzip-compressed curated CSV tables and their SHA-256 manifest have been prepared as an offline research package. **Their complete upload to the separate private `kerala2040-source-archive` repository is not yet verified; do not treat the private archive as a backed-up copy of this dataset.** The original third-party HTML ZIP remains in the user-held source archive; no source HTML or source-labelled private CSV table is committed to this public research repository. Private access does not grant public redistribution rights.
