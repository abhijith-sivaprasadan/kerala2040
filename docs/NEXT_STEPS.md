...
## CET 2026 WP8 finance and federal value capture: source-scoped first phase complete · 24 September 2026

[WP8 finance chapter](WP8_FINANCE_FEDERAL_VALUE_CAPTURE_2026_09_24.md) and [public-source finance ledger](../data/evidence/finance/wp8_finance_source_ledger_2026_09_24.json) now separate the **FY2025–26 published *proposed* energy plan** from the CAG **FY2024–25 *statewide* fiscal audit**, with six distinct economic/fiscal/utility/Union/private/consumer money boundaries and six conditional project-funding structures. Exact energy plan and KSEBL own/external/State Plan category sums are checked before website release; the PDF publisher text transcription still needs page-image QA. Statewide guarantees are contingent and **not** bookable as a KSEBL guarantee or Kerala2040 project financing. The project template contains no selected discount rate, project capex, annual benefits or Kerala government funding percentage; a modeled scenario is not declared solved.

**Newly identified evidence gate:** as-issued Power Demand budget heads; FY2020–21 onward BE/RE/actual and treasury releases; KSEBL audited capex, financing and subsidies; current KSERC order-specific approvals and tariff recovery; named Union/central-PSU sanctions and project-level guarantees. Publicly releasable documents suffice; no confidential Secretariat records or unauthorised workplace access. The first distinct finance deliverable is completed; numerical cost/affordability/fiscal sensitivity stays blocked.
