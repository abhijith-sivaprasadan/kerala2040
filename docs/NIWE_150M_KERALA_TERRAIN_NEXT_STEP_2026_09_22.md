...
The slope TIFF's default SHA256 must equal `72551921c99eb563abe37c9502d4e4c592c3be667f31459296c90e48be9436f7`; an alternate raster is rejected unless `--allow-unpinned-slope` is explicitly passed after independent QA. The run reports whether the slope hash matched.
