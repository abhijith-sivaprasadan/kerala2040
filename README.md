...
## Finance and federal value capture · WP8 source-scoped milestone · 24 September 2026

[Research chapter: Who pays, owns and benefits?](docs/WP8_FINANCE_FEDERAL_VALUE_CAPTURE_2026_09_24.md) · [Machine-readable public-source ledger](data/evidence/finance/wp8_finance_source_ledger_2026_09_24.json) · [Interactive Pathways finance explorer](https://kerala2040.github.io/#pathways).

WP8 now distinguishes **whole-system costs, Kerala treasury expenditure, KSEBL utility funds and liabilities, Union/central-PSU sanctions, private/development capital and consumer outcomes**. The FY2025–26 State Planning Board agency plan provides **proposed** energy outlays with KSEBL *own-fund*, externally aided and State Plan entries expressly separate; publisher PDF text is extracted but **page-image QA remains open**. FY2024–25 CAG **statewide** deficit and guarantee accounts are recorded separately and must not be relabelled power expenditure or investible capital. Six conditional finance structures and a fail-closed registry preserve **null** candidate-project costs and 2040 finance shares. This is a finished **source-scoped finance accounting framework**, not approved project appraisal, actual grant-release series or Kerala2040 financing recommendation.
